package org.pwrd.paho.client.mqttv3.util;
...
public class Debug {
    ...
    public void dumpVersion() {
        ...
        vInfo.append(String.valueOf(left("Version", 20, ' ')) + ":  " + ClientComms.VERSION + lineSep);
        vInfo.append(String.valueOf(left("Build Level", 20, ' ')) + ":  " + ClientComms.BUILD_LEVEL + lineSep);
    ...
    public static String dumpProperties(Properties props, String name) {
        ...
        while (propsE.hasMoreElements()) {
            ...
            propStr.append(String.valueOf(left(key, 28, ' ')) + ":  " + props.get(key) + lineSep);
        }

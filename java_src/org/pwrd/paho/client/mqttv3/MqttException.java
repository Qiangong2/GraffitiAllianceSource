...
import org.pwrd.paho.client.mqttv3.internal.MessageCatalog;
...
public class MqttException extends Exception {
    ...
    public MqttException(int reasonCode2) {
        this.reasonCode = reasonCode2;
    }

    public MqttException(Throwable cause2) {
        this.reasonCode = 0;
        this.cause = cause2;
    }

    public MqttException(int reason, Throwable cause2) {
    ...
    public String toString() {
        String result = String.valueOf(getMessage()) + " (" + this.reasonCode + ")";
        if (this.cause != null) {
            return String.valueOf(result) + " - " + this.cause.toString();
        }
        return result;
    }
}

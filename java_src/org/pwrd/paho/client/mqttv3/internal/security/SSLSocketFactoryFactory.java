package org.pwrd.paho.client.mqttv3.internal.security;
...
import org.pwrd.paho.client.mqttv3.MqttSecurityException;
...
public class SSLSocketFactoryFactory {
    ...
    private static final String CLASS_NAME = "org.pwrd.paho.client.mqttv3.internal.security.SSLSocketFactoryFactory";
    ...
    private void convertPassword(Properties p) {
        ...
        if (pw2 != null && !pw2.startsWith(xorTag)) {
            p.put(TRUSTSTOREPWD, obfuscate(pw2.toCharArray()));
        }
    }

...
public class BitmapCompat {
    ...
    static class BaseBitmapImpl implements BitmapImpl {
        ...
        @Override // android.support.p007v4.graphics.BitmapCompat.BitmapImpl
    ...
    static class HcMr1BitmapCompatImpl extends BaseBitmapImpl {
        ...
        @Override // android.support.p007v4.graphics.BitmapCompat.BaseBitmapImpl, android.support.p007v4.graphics.BitmapCompat.BitmapImpl
        public int getAllocationByteCount(Bitmap bitmap) {
    ...
    static class KitKatBitmapCompatImpl extends JbMr2BitmapCompatImpl {
        ...
        @Override // android.support.p007v4.graphics.BitmapCompat.BaseBitmapImpl, android.support.p007v4.graphics.BitmapCompat.BitmapImpl, android.support.p007v4.graphics.BitmapCompat.HcMr1BitmapCompatImpl
        public int getAllocationByteCount(Bitmap bitmap) {

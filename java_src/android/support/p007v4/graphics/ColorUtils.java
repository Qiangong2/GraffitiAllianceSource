...
public class ColorUtils {
    ...
    @FloatRange(from = 0.0d, mo145to = 1.0d)
    public static double calculateLuminance(@ColorInt int color) {
        double red = ((double) Color.red(color)) / 255.0d;
        double red2 = red < 0.03928d ? red / 12.92d : Math.pow((0.055d + red) / 1.055d, 2.4d);
        double green = ((double) Color.green(color)) / 255.0d;
        double green2 = green < 0.03928d ? green / 12.92d : Math.pow((0.055d + green) / 1.055d, 2.4d);
        double blue = ((double) Color.blue(color)) / 255.0d;
        return (0.2126d * red2) + (0.7152d * green2) + (0.0722d * (blue < 0.03928d ? blue / 12.92d : Math.pow((0.055d + blue) / 1.055d, 2.4d)));
    }
    ...
    public static void RGBToHSL(@IntRange(from = 0, mo150to = 255) int r, @IntRange(from = 0, mo150to = 255) int g, @IntRange(from = 0, mo150to = 255) int b, @NonNull float[] hsl) {
        float h;
        float s;
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int color, @IntRange(from = 0, mo150to = 255) int alpha) {

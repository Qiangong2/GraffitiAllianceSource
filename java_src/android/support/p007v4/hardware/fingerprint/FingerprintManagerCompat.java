...
import android.support.p007v4.hardware.fingerprint.FingerprintManagerCompatApi23;
...
public class FingerprintManagerCompat {
    ...
    private static class LegacyFingerprintManagerCompatImpl implements FingerprintManagerCompatImpl {
        @Override // android.support.p007v4.hardware.fingerprint.FingerprintManagerCompat.FingerprintManagerCompatImpl
    ...
    private static class Api23FingerprintManagerCompatImpl implements FingerprintManagerCompatImpl {
        ...
        private static FingerprintManagerCompatApi23.AuthenticationCallback wrapCallback(final AuthenticationCallback callback) {
            return new FingerprintManagerCompatApi23.AuthenticationCallback() {
                /* class android.support.p007v4.hardware.fingerprint.FingerprintManagerCompat.Api23FingerprintManagerCompatImpl.C00991 */

                @Override // android.support.p007v4.hardware.fingerprint.FingerprintManagerCompatApi23.AuthenticationCallback
                public void onAuthenticationError(int errMsgId, CharSequence errString) {

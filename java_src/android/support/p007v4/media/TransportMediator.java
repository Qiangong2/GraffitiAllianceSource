...
public class TransportMediator extends TransportController {
    ...
    static boolean isMediaKey(int keyCode) {
        switch (keyCode) {
            ...
            case KEYCODE_MEDIA_RECORD /*{ENCODED_INT: 130}*/:
                return true;
            default:
                return false;
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new TransportMediatorCallback() {
            /* class android.support.p007v4.media.TransportMediator.C01221 */

            @Override // android.support.p007v4.media.TransportMediatorCallback
        ...
        this.mKeyEventCallback = new KeyEvent.Callback() {
            /* class android.support.p007v4.media.TransportMediator.KeyEvent$CallbackC01232 */
    ...
    @Override // android.support.p007v4.media.TransportController

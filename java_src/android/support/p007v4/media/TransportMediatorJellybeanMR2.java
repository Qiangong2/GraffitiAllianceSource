...
class TransportMediatorJellybeanMR2 {
    AudioManager.OnAudioFocusChangeListener mAudioFocusChangeListener = new AudioManager.OnAudioFocusChangeListener() {
        /* class android.support.p007v4.media.TransportMediatorJellybeanMR2.C01274 */
    ...
    final RemoteControlClient.OnGetPlaybackPositionListener mGetPlaybackPositionListener = new RemoteControlClient.OnGetPlaybackPositionListener() {
        /* class android.support.p007v4.media.TransportMediatorJellybeanMR2.C01285 */
    ...
    final BroadcastReceiver mMediaButtonReceiver = new BroadcastReceiver() {
        /* class android.support.p007v4.media.TransportMediatorJellybeanMR2.C01263 */
    ...
    final RemoteControlClient.OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new RemoteControlClient.OnPlaybackPositionUpdateListener() {
        /* class android.support.p007v4.media.TransportMediatorJellybeanMR2.C01296 */
    ...
    final ViewTreeObserver.OnWindowAttachListener mWindowAttachListener = new ViewTreeObserver.OnWindowAttachListener() {
        /* class android.support.p007v4.media.TransportMediatorJellybeanMR2.ViewTreeObserver$OnWindowAttachListenerC01241 */
    ...
    final ViewTreeObserver.OnWindowFocusChangeListener mWindowFocusListener = new ViewTreeObserver.OnWindowFocusChangeListener() {
        /* class android.support.p007v4.media.TransportMediatorJellybeanMR2.ViewTreeObserver$OnWindowFocusChangeListenerC01252 */
    ...
    public void windowAttached() {
        ...
        this.mPendingIntent = PendingIntent.getBroadcast(this.mContext, 0, this.mIntent, ClientDefaults.MAX_MSG_SIZE);

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 25:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_sendCustomAction /*{ENCODED_INT: 26}*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    sendCustomAction(_arg07, _arg1);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getMetadata /*{ENCODED_INT: 27}*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_getPlaybackState /*{ENCODED_INT: 28}*/:
                    data.enforceInterface(DESCRIPTOR);

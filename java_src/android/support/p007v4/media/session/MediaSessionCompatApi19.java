...
public class MediaSessionCompatApi19 {
    ...
    static void addNewMetadata(Bundle metadata, RemoteControlClient.MetadataEditor editor) {
        if (metadata != null) {
            ...
            if (metadata.containsKey("android.media.metadata.RATING")) {
                editor.putObject(ResponseCode.PUSH_OPEN_FAIL_CODE, (Object) metadata.getParcelable("android.media.metadata.RATING"));
            }
    ...
    public static class OnMetadataUpdateListener<T extends MediaSessionCompatApi14.Callback> implements RemoteControlClient.OnMetadataUpdateListener {

...
import android.support.p007v4.media.session.IMediaControllerCallback;
import android.support.p007v4.media.session.IMediaSession;
import android.support.p007v4.media.session.MediaControllerCompatApi21;
import android.support.p007v4.media.session.MediaControllerCompatApi23;
...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            @Override // android.support.p007v4.media.session.MediaControllerCompatApi21.Callback
            public void onSessionDestroyed() {
        ...
        private class StubCompat extends IMediaControllerCallback.Stub {
            ...
            @Override // android.support.p007v4.media.session.IMediaControllerCallback
    ...
    static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        @Override // android.support.p007v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void registerCallback(Callback callback, Handler handler) {
            if (callback == null) {
    ...
    static class TransportControlsBase extends TransportControls {
        ...
        @Override // android.support.p007v4.media.session.MediaControllerCompat.TransportControls
        public void play() {
            try {
                this.mBinder.play();
            } catch (RemoteException e) {
    ...
    static class MediaControllerImplApi23 extends MediaControllerImplApi21 {
        ...
        @Override // android.support.p007v4.media.session.MediaControllerCompat.MediaControllerImpl, android.support.p007v4.media.session.MediaControllerCompat.MediaControllerImplApi21
        public TransportControls getTransportControls() {
            Object controlsObj = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
            if (controlsObj != null) {
    ...
    static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        @Override // android.support.p007v4.media.session.MediaControllerCompat.TransportControls, android.support.p007v4.media.session.MediaControllerCompat.TransportControlsApi21
        public void playFromUri(Uri uri, Bundle extras) {

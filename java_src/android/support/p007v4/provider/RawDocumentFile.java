package android.support.p007v4.provider;
...
class RawDocumentFile extends DocumentFile {
    ...
    @Override // android.support.p007v4.provider.DocumentFile
    ...
    private static String getTypeForName(String name) {
        ...
        return (lastDot < 0 || (mime = MimeTypeMap.getSingleton().getMimeTypeFromExtension(name.substring(lastDot + 1).toLowerCase())) == null) ? COSRequestHeaderKey.APPLICATION_OCTET_STREAM : mime;
    }

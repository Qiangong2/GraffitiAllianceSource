...
import android.support.p007v4.app.ActivityCompatApi23;
...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompatApi23.RequestPermissionsRequestCodeValidator {
    ...
    final Handler mHandler = new Handler() {
        /* class android.support.p007v4.app.FragmentActivity.HandlerC00701 */
    ...
    @Override // android.support.p007v4.app.BaseFragmentActivityHoneycomb
    ...
    @Override // android.support.p007v4.app.BaseFragmentActivityDonut
    ...
    private static String viewToString(View view) {
        ...
        if (id != -1) {
            ...
            if (!(id == 0 || r == null)) {
                switch (-16777216 & id) {
                    case ViewCompat.MEASURED_STATE_TOO_SMALL /*{ENCODED_INT: 16777216}*/:
                        pkgname = "android";
                        ...
                        out.append(":");
                        out.append(typename);
                        out.append(MqttTopic.TOPIC_LEVEL_SEPARATOR);
    ...
    @Override // android.support.p007v4.app.ActivityCompatApi23.RequestPermissionsRequestCodeValidator
    ...
    @Override // android.support.p007v4.app.ActivityCompat.OnRequestPermissionsResultCallback
    ...
    class HostCallbacks extends FragmentHostCallback<FragmentActivity> {
        ...
        @Override // android.support.p007v4.app.FragmentHostCallback
        ...
        @Override // android.support.p007v4.app.FragmentContainer, android.support.p007v4.app.FragmentHostCallback
        @Nullable

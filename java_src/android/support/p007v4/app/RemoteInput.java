...
public class RemoteInput extends RemoteInputCompatBase.RemoteInput {
    ...
    public static final RemoteInputCompatBase.RemoteInput.Factory FACTORY = new RemoteInputCompatBase.RemoteInput.Factory() {
        /* class android.support.p007v4.app.RemoteInput.C00921 */

        @Override // android.support.p007v4.app.RemoteInputCompatBase.RemoteInput.Factory
    ...
    @Override // android.support.p007v4.app.RemoteInputCompatBase.RemoteInput
    ...
    static class ImplBase implements Impl {
        ...
        @Override // android.support.p007v4.app.RemoteInput.Impl

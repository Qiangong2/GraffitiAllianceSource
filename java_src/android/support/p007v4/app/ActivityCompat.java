...
import android.support.p007v4.app.ActivityCompat21;
...
public class ActivityCompat extends ContextCompat {
    ...
    public static void requestPermissions(@NonNull final Activity activity, @NonNull final String[] permissions, final int requestCode) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                /* class android.support.p007v4.app.ActivityCompat.RunnableC00611 */
    ...
    public static class SharedElementCallback21Impl extends ActivityCompat21.SharedElementCallback21 {
        ...
        @Override // android.support.p007v4.app.ActivityCompat21.SharedElementCallback21

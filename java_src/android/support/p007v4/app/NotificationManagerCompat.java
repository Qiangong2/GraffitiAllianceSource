...
import android.support.p007v4.app.INotificationSideChannel;
...
public class NotificationManagerCompat {
    ...
    static class ImplBase implements Impl {
        ...
        @Override // android.support.p007v4.app.NotificationManagerCompat.Impl
    ...
    static class ImplEclair extends ImplBase {
        ...
        @Override // android.support.p007v4.app.NotificationManagerCompat.ImplBase, android.support.p007v4.app.NotificationManagerCompat.Impl
        public void cancelNotification(NotificationManager notificationManager, String tag, int id) {
    ...
    public static class NotifyTask implements Task {
        ...
        @Override // android.support.p007v4.app.NotificationManagerCompat.Task
        public void send(INotificationSideChannel service) throws RemoteException {
            service.notify(this.packageName, this.f150id, this.tag, this.notif);
        }

        public String toString() {
            StringBuilder sb = new StringBuilder("NotifyTask[");
            sb.append("packageName:").append(this.packageName);
            sb.append(", id:").append(this.f150id);
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel service) throws RemoteException {
            if (this.all) {
                ...
                service.cancel(this.packageName, this.f149id, this.tag);
            }
        }
        ...
        public String toString() {
            ...
            sb.append("packageName:").append(this.packageName);
            sb.append(", id:").append(this.f149id);
            sb.append(", tag:").append(this.tag);

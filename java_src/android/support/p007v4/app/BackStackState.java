...
public final class BackStackState implements Parcelable {
    public static final Parcelable.Creator<BackStackState> CREATOR = new Parcelable.Creator<BackStackState>() {
        /* class android.support.p007v4.app.BackStackState.C00671 */
    ...
    public BackStackState(BackStackRecord bse) {
        int pos;
        int numRemoved = 0;
        for (BackStackRecord.C0066Op op = bse.mHead; op != null; op = op.next) {
            if (op.removed != null) {
        ...
        BackStackRecord.C0066Op op2 = bse.mHead;
        int pos2 = 0;
        while (op2 != null) {
            int pos3 = pos2 + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fm) {
        ...
        while (pos < this.mOps.length) {
            BackStackRecord.C0066Op op = new BackStackRecord.C0066Op();
            int pos2 = pos + 1;

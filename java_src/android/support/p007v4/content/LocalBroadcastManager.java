...
public class LocalBroadcastManager {
    ...
    private LocalBroadcastManager(Context context) {
        ...
        this.mHandler = new Handler(context.getMainLooper()) {
            /* class android.support.p007v4.content.LocalBroadcastManager.HandlerC00931 */
    ...
    private void executePendingBroadcasts() {
        ...
        L_0x0000:
            ...
            return
        L_0x000e:
            android.support.v4.content.LocalBroadcastManager$BroadcastRecord[] r2 = new android.support.p007v4.content.LocalBroadcastManager.BroadcastRecord[r0]     // Catch:{ all -> 0x003e }
            java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$BroadcastRecord> r5 = r8.mPendingBroadcasts     // Catch:{ all -> 0x003e }
        ...
        L_0x0022:
            ...
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r5 = (android.support.p007v4.content.LocalBroadcastManager.ReceiverRecord) r5

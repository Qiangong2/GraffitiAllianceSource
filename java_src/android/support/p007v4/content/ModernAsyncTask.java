...
public abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        /* class android.support.p007v4.content.ModernAsyncTask.ThreadFactoryC00941 */
    ...
    private final FutureTask<Result> mFuture = new FutureTask<Result>(this.mWorker) {
        /* class android.support.p007v4.content.ModernAsyncTask.C00963 */
    ...
    private final WorkerRunnable<Params, Result> mWorker = new WorkerRunnable<Params, Result>() {
        /* class android.support.p007v4.content.ModernAsyncTask.C00952 */

        /* JADX DEBUG: Multi-variable search result rejected for r1v1, resolved type: android.support.v4.content.ModernAsyncTask */

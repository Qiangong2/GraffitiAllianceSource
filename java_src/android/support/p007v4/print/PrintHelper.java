...
import android.support.p007v4.print.PrintHelperKitkat;
...
public final class PrintHelper {
    ...
    private static final class PrintHelperStubImpl implements PrintHelperVersionImpl {
        ...
        @Override // android.support.p007v4.print.PrintHelper.PrintHelperVersionImpl
    ...
    private static final class PrintHelperKitkatImpl implements PrintHelperVersionImpl {
        ...
        public void printBitmap(String jobName, Bitmap bitmap, final OnPrintFinishCallback callback) {
            ...
            if (callback != null) {
                delegateCallback = new PrintHelperKitkat.OnPrintFinishCallback() {
                    /* class android.support.p007v4.print.PrintHelper.PrintHelperKitkatImpl.C01461 */

                    @Override // android.support.p007v4.print.PrintHelperKitkat.OnPrintFinishCallback
        ...
        public void printBitmap(String jobName, Uri imageFile, final OnPrintFinishCallback callback) throws FileNotFoundException {
            ...
            if (callback != null) {
                delegateCallback = new PrintHelperKitkat.OnPrintFinishCallback() {
                    /* class android.support.p007v4.print.PrintHelper.PrintHelperKitkatImpl.C01472 */

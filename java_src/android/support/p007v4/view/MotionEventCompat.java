...
public class MotionEventCompat {
    ...
    static class BaseMotionEventVersionImpl implements MotionEventVersionImpl {
        ...
        @Override // android.support.p007v4.view.MotionEventCompat.MotionEventVersionImpl
    ...
    static class EclairMotionEventVersionImpl extends BaseMotionEventVersionImpl {
        ...
        @Override // android.support.p007v4.view.MotionEventCompat.BaseMotionEventVersionImpl, android.support.p007v4.view.MotionEventCompat.MotionEventVersionImpl
        public int findPointerIndex(MotionEvent event, int pointerId) {

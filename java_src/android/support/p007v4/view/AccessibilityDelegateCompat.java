...
import android.support.p007v4.view.AccessibilityDelegateCompatIcs;
import android.support.p007v4.view.AccessibilityDelegateCompatJellyBean;
import android.support.p007v4.view.accessibility.AccessibilityNodeInfoCompat;
import android.support.p007v4.view.accessibility.AccessibilityNodeProviderCompat;
...
public class AccessibilityDelegateCompat {
    ...
    static class AccessibilityDelegateStubImpl implements AccessibilityDelegateImpl {
        ...
        @Override // android.support.p007v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl
    ...
    static class AccessibilityDelegateIcsImpl extends AccessibilityDelegateStubImpl {
        ...
        @Override // android.support.p007v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl, android.support.p007v4.view.AccessibilityDelegateCompat.AccessibilityDelegateStubImpl
        public Object newAccessiblityDelegateDefaultImpl() {
        ...
        public Object newAccessiblityDelegateBridge(final AccessibilityDelegateCompat compat) {
            return AccessibilityDelegateCompatIcs.newAccessibilityDelegateBridge(new AccessibilityDelegateCompatIcs.AccessibilityDelegateBridge() {
                /* class android.support.p007v4.view.AccessibilityDelegateCompat.AccessibilityDelegateIcsImpl.C01581 */

                @Override // android.support.p007v4.view.AccessibilityDelegateCompatIcs.AccessibilityDelegateBridge
    ...
    static class AccessibilityDelegateJellyBeanImpl extends AccessibilityDelegateIcsImpl {
        ...
        @Override // android.support.p007v4.view.AccessibilityDelegateCompat.AccessibilityDelegateIcsImpl, android.support.p007v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl, android.support.p007v4.view.AccessibilityDelegateCompat.AccessibilityDelegateStubImpl
        public Object newAccessiblityDelegateBridge(final AccessibilityDelegateCompat compat) {
            return AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new AccessibilityDelegateCompatJellyBean.AccessibilityDelegateBridgeJellyBean() {
                /* class android.support.p007v4.view.AccessibilityDelegateCompat.AccessibilityDelegateJellyBeanImpl.C01591 */

                @Override // android.support.p007v4.view.AccessibilityDelegateCompatJellyBean.AccessibilityDelegateBridgeJellyBean
                public boolean dispatchPopulateAccessibilityEvent(View host, AccessibilityEvent event) {
                    return compat.dispatchPopulateAccessibilityEvent(host, event);
                }

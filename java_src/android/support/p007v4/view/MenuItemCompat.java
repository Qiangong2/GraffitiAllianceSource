...
import android.support.p007v4.view.MenuItemCompatIcs;
...
public class MenuItemCompat {
    ...
    static class BaseMenuVersionImpl implements MenuVersionImpl {
        ...
        @Override // android.support.p007v4.view.MenuItemCompat.MenuVersionImpl
    ...
    static class IcsMenuVersionImpl extends HoneycombMenuVersionImpl {
        ...
        @Override // android.support.p007v4.view.MenuItemCompat.HoneycombMenuVersionImpl, android.support.p007v4.view.MenuItemCompat.MenuVersionImpl
        public boolean expandActionView(MenuItem item) {
        ...
        public MenuItem setOnActionExpandListener(MenuItem item, final OnActionExpandListener listener) {
            ...
            return MenuItemCompatIcs.setOnActionExpandListener(item, new MenuItemCompatIcs.SupportActionExpandProxy() {
                /* class android.support.p007v4.view.MenuItemCompat.IcsMenuVersionImpl.C01621 */

                @Override // android.support.p007v4.view.MenuItemCompatIcs.SupportActionExpandProxy

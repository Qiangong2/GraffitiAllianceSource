...
import android.support.p007v4.p009os.ParcelableCompat;
import android.support.p007v4.p009os.ParcelableCompatCreatorCallbacks;
import android.support.p007v4.view.accessibility.AccessibilityNodeInfoCompat;
import android.support.p007v4.view.accessibility.AccessibilityRecordCompat;
import android.support.p007v4.widget.EdgeEffectCompat;
...
import com.umeng.analytics.p086a.p089c.C1392c;
...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() {
        /* class android.support.p007v4.view.ViewPager.C01681 */
    ...
    private static final Interpolator sInterpolator = new Interpolator() {
        /* class android.support.p007v4.view.ViewPager.animationInterpolatorC01692 */
    ...
    private final Runnable mEndScrollRunnable = new Runnable() {
        /* class android.support.p007v4.view.ViewPager.RunnableC01703 */
    ...
    public static class SimpleOnPageChangeListener implements OnPageChangeListener {
        @Override // android.support.p007v4.view.ViewPager.OnPageChangeListener
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() {
            /* class android.support.p007v4.view.ViewPager.SavedState.C01711 */

            @Override // android.support.p007v4.p009os.ParcelableCompatCreatorCallbacks
                ...
                if (lp.isDecor) {
                    ...
                    switch (vgrav) {
                        case 16:
                            ...
                            break;
                        case C1392c.f3289a /*{ENCODED_INT: 48}*/:
                            childTop = paddingTop;
    ...
    public class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        @Override // android.support.p007v4.view.AccessibilityDelegateCompat

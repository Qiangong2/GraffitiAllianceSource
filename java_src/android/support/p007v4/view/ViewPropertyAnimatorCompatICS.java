...
class ViewPropertyAnimatorCompatICS {
    ...
    /* renamed from: x */
    public static void m336x(View view, float value) {
    ...
    /* renamed from: y */
    public static void m337y(View view, float value) {
    ...
    public static void setListener(final View view, final ViewPropertyAnimatorListener listener) {
        if (listener != null) {
            view.animate().setListener(new AnimatorListenerAdapter() {
                /* class android.support.p007v4.view.ViewPropertyAnimatorCompatICS.C01731 */

...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public static class SimplePanelSlideListener implements PanelSlideListener {
        @Override // android.support.p007v4.widget.SlidingPaneLayout.PanelSlideListener
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            if (!isInEditMode()) {
                ...
                if (widthMode == 0) {
                    widthSize = GCloudVoiceErrno.GCLOUD_VOICE_TVE_CREATE;
                }
            }
            ...
            if (!isInEditMode()) {
                ...
                heightSize = GCloudVoiceErrno.GCLOUD_VOICE_TVE_CREATE;
            }
        }
        int layoutHeight = 0;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.width == -2) {
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, ExploreByTouchHelper.INVALID_ID);
                } else if (lp.width == -1) {
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        @Override // android.support.p007v4.widget.ViewDragHelper.Callback
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class android.support.p007v4.widget.SlidingPaneLayout.SavedState.C02001 */
    ...
    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        ...
        @Override // android.support.p007v4.widget.SlidingPaneLayout.SlidingPanelLayoutImpl
    ...
    static class SlidingPanelLayoutImplJB extends SlidingPanelLayoutImplBase {
        ...
        @Override // android.support.p007v4.widget.SlidingPaneLayout.SlidingPanelLayoutImplBase, android.support.p007v4.widget.SlidingPaneLayout.SlidingPanelLayoutImpl
        public void invalidateChildRegion(SlidingPaneLayout parent, View child) {

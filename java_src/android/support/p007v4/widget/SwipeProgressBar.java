    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (rawProgress >= 0.0f && rawProgress <= 25.0f) {
                drawCircle(canvas, (float) cx, (float) cy, this.mColor1, ((25.0f + rawProgress) * 2.0f) / 100.0f);
            }
            if (rawProgress >= 0.0f && rawProgress <= 50.0f) {
                drawCircle(canvas, (float) cx, (float) cy, this.mColor2, (2.0f * rawProgress) / 100.0f);
            }

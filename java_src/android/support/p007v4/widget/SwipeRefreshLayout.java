...
import android.support.p007v4.view.NestedScrollingChild;
import android.support.p007v4.view.NestedScrollingChildHelper;
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new Animation.AnimationListener() {
            /* class android.support.p007v4.widget.SwipeRefreshLayout.animationAnimation$AnimationListenerC02011 */
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            /* class android.support.p007v4.widget.SwipeRefreshLayout.C02066 */
        ...
        this.mAnimateToStartPosition = new Animation() {
            /* class android.support.p007v4.widget.SwipeRefreshLayout.C02077 */
    ...
    private void startScaleUpAnimation(Animation.AnimationListener listener) {
        ...
        this.mScaleAnimation = new Animation() {
            /* class android.support.p007v4.widget.SwipeRefreshLayout.C02022 */
    ...
    private void startScaleDownAnimation(Animation.AnimationListener listener) {
        this.mScaleDownAnimation = new Animation() {
            /* class android.support.p007v4.widget.SwipeRefreshLayout.C02033 */
    ...
    private Animation startAlphaAnimation(final int startingAlpha, final int endingAlpha) {
        ...
        Animation alpha = new Animation() {
            /* class android.support.p007v4.widget.SwipeRefreshLayout.C02044 */
    ...
    @Override // android.support.p007v4.view.NestedScrollingParent
    ...
    @Override // android.support.p007v4.view.NestedScrollingChild
    ...
    private void finishSpinner(float overscrollTop) {
        ...
        if (!this.mScale) {
            listener = new Animation.AnimationListener() {
                /* class android.support.p007v4.widget.SwipeRefreshLayout.animationAnimation$AnimationListenerC02055 */
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case 1:
                ...
                float overscrollTop = (MotionEventCompat.getY(ev, pointerIndex) - this.mInitialMotionY) * DRAG_RATE;
                this.mIsBeingDragged = false;
            ...
            case 2:
                ...
                float overscrollTop2 = (MotionEventCompat.getY(ev, pointerIndex2) - this.mInitialMotionY) * DRAG_RATE;
    ...
    private void startScaleDownReturnToStartAnimation(int from, Animation.AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new Animation() {
            /* class android.support.p007v4.widget.SwipeRefreshLayout.C02088 */

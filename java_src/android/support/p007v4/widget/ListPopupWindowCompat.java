...
public class ListPopupWindowCompat {
    ...
    static class BaseListPopupWindowImpl implements ListPopupWindowImpl {
        ...
        @Override // android.support.p007v4.widget.ListPopupWindowCompat.ListPopupWindowImpl
    ...
    static class KitKatListPopupWindowImpl extends BaseListPopupWindowImpl {
        ...
        @Override // android.support.p007v4.widget.ListPopupWindowCompat.ListPopupWindowImpl, android.support.p007v4.widget.ListPopupWindowCompat.BaseListPopupWindowImpl
        public View.OnTouchListener createDragToOpenListener(Object listPopupWindow, View src) {

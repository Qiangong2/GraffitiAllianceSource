...
import android.support.p007v4.widget.CursorFilter;
...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public void init(Context context, Cursor c, int flags) {
        ...
        this.mRowIDColumn = cursorPresent ? c.getColumnIndexOrThrow(FieldType.FOREIGN_ID_FIELD_SUFFIX) : -1;
        if ((flags & 2) == 2) {
    ...
    @Override // android.support.p007v4.widget.CursorFilter.CursorFilterClient

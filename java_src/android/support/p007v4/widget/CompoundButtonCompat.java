...
public final class CompoundButtonCompat {
    ...
    static class BaseCompoundButtonCompat implements CompoundButtonCompatImpl {
        ...
        @Override // android.support.p007v4.widget.CompoundButtonCompat.CompoundButtonCompatImpl
    ...
    static class LollipopCompoundButtonImpl extends BaseCompoundButtonCompat {
        ...
        @Override // android.support.p007v4.widget.CompoundButtonCompat.BaseCompoundButtonCompat, android.support.p007v4.widget.CompoundButtonCompat.CompoundButtonCompatImpl
        public void setButtonTintList(CompoundButton button, ColorStateList tint) {

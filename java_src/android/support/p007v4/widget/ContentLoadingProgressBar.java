...
public class ContentLoadingProgressBar extends ProgressBar {
    ...
    public ContentLoadingProgressBar(Context context, AttributeSet attrs) {
        ...
        this.mDelayedHide = new Runnable() {
            /* class android.support.p007v4.widget.ContentLoadingProgressBar.RunnableC01851 */
        ...
        this.mDelayedShow = new Runnable() {
            /* class android.support.p007v4.widget.ContentLoadingProgressBar.RunnableC01862 */

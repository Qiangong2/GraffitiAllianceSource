...
import android.support.p007v4.view.ViewParentCompat;
import android.support.p007v4.view.accessibility.AccessibilityEventCompat;
import android.support.p007v4.view.accessibility.AccessibilityManagerCompat;
...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    private AccessibilityNodeInfoCompat createNodeForHost() {
        ...
        while (i$.hasNext()) {
            node.addChild(this.mView, i$.next().intValue());
        }
        return node;
    }
    ...
    private class ExploreByTouchNodeProvider extends AccessibilityNodeProviderCompat {
        ...
        @Override // android.support.p007v4.view.accessibility.AccessibilityNodeProviderCompat

...
public class EdgeEffectCompat {
    ...
    static class BaseEdgeEffectImpl implements EdgeEffectImpl {
        ...
        @Override // android.support.p007v4.widget.EdgeEffectCompat.EdgeEffectImpl
    ...
    static class EdgeEffectLollipopImpl extends EdgeEffectIcsImpl {
        ...
        @Override // android.support.p007v4.widget.EdgeEffectCompat.EdgeEffectImpl, android.support.p007v4.widget.EdgeEffectCompat.EdgeEffectIcsImpl
        public boolean onPull(Object edgeEffect, float deltaDistance, float displacement) {

...
public final class MultiDex {
    ...
    public static final class V19 {
        ...
        private static Object[] makeDexElements(Object dexPathList, ArrayList<File> files, File optimizedDirectory, ArrayList<IOException> suppressedExceptions) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
            return (Object[]) MultiDex.findMethod(dexPathList, "makeDexElements", new Class[]{ArrayList.class, File.class, ArrayList.class}).invoke(dexPathList, files, optimizedDirectory, suppressedExceptions);
        }
    }
    ...
    public static final class V14 {
        ...
        private static Object[] makeDexElements(Object dexPathList, ArrayList<File> files, File optimizedDirectory) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
            return (Object[]) MultiDex.findMethod(dexPathList, "makeDexElements", new Class[]{ArrayList.class, File.class}).invoke(dexPathList, files, optimizedDirectory);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: android.support.multidex.MultiDex$V4 */
    public static final class C0056V4 {
        private C0056V4() {
        }

...
public class RuntimeExceptionDao<T, ID> implements CloseableIterable<T> {
    ...
    public T queryForId(ID id) {
        try {
            ...
            logMessage(e, "queryForId threw exception on: " + ((Object) id));
    ...
    public List<T> queryForMatching(T matchObj) {
        try {
            ...
            logMessage(e, "queryForMatching threw exception on: " + ((Object) matchObj));
            throw new RuntimeException(e);
        }
    }
    ...
    public List<T> queryForMatchingArgs(T matchObj) {
        try {
            ...
            logMessage(e, "queryForMatchingArgs threw exception on: " + ((Object) matchObj));
            throw new RuntimeException(e);
        }
    }
    ...
    public T queryForSameId(T data) {
        try {
            ...
            logMessage(e, "queryForSameId threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public int create(T data) {
        try {
            ...
            logMessage(e, "create threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public T createIfNotExists(T data) {
        try {
            ...
            logMessage(e, "createIfNotExists threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public Dao.CreateOrUpdateStatus createOrUpdate(T data) {
        try {
            ...
            logMessage(e, "createOrUpdate threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public int update(T data) {
        try {
            ...
            logMessage(e, "update threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public int updateId(T data, ID newId) {
        try {
            ...
            logMessage(e, "updateId threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public int refresh(T data) {
        try {
            ...
            logMessage(e, "refresh threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public int delete(T data) {
        try {
            return this.dao.delete((Object) data);
        } catch (SQLException e) {
            logMessage(e, "delete threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public int deleteById(ID id) {
        try {
            ...
            logMessage(e, "deleteById threw exception on: " + ((Object) id));
            throw new RuntimeException(e);
        }
    }
    ...
    public boolean objectsEqual(T data1, T data2) {
        try {
            ...
            logMessage(e, "objectsEqual threw exception on: " + ((Object) data1) + " and " + ((Object) data2));
            throw new RuntimeException(e);
        }
    }
    ...
    public ID extractId(T data) {
        try {
            ...
            logMessage(e, "extractId threw exception on: " + ((Object) data));
            throw new RuntimeException(e);
        }
    }
    ...
    public boolean idExists(ID id) {
        try {
            ...
            logMessage(e, "idExists threw exception on " + ((Object) id));
            throw new RuntimeException(e);
        }
    }
    ...
    public void setAutoCommit(DatabaseConnection connection, boolean autoCommit) {
        try {
            ...
            logMessage(e, "setAutoCommit(" + connection + MiPushClient.ACCEPT_TIME_SEPARATOR + autoCommit + ") threw exception");
            throw new RuntimeException(e);
        }
    }

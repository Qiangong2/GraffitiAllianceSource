...
public class FieldType {
    ...
    private static final ThreadLocal<LevelCounters> threadLevelCounters = new ThreadLocal<LevelCounters>() {
        /* class com.j256.ormlite.field.FieldType.C11881 */
    ...
    public FieldType(ConnectionSource connectionSource2, String tableName2, Field field2, DatabaseFieldConfig fieldConfig2, Class<?> cls) throws SQLException {
        ...
        if (fieldConfig2.getDataPersister() == null) {
            Class<? extends DataPersister> persisterClass = fieldConfig2.getPersisterClass();
        ...
        if (fieldConfig2.isForeign() || fieldConfig2.isForeignAutoRefresh() || foreignColumnName != null) {
            if (dataPersister2 == null || !dataPersister2.isPrimitive()) {
                if (foreignColumnName == null) {
                    defaultFieldName = String.valueOf(defaultFieldName) + FOREIGN_ID_FIELD_SUFFIX;
                } else {
                    defaultFieldName = String.valueOf(defaultFieldName) + "_" + foreignColumnName;
                }
            ...
            if (byte[].class.isAssignableFrom(clazz)) {
                throw new SQLException("ORMLite can't store unknown class " + clazz + " for field '" + field2.getName() + "'. byte[] fields must specify dataType=DataType.BYTE_ARRAY or SERIALIZABLE");
            } else if (Serializable.class.isAssignableFrom(clazz)) {
                throw new SQLException("ORMLite can't store unknown class " + clazz + " for field '" + field2.getName() + "'. Serializable fields must specify dataType=DataType.SERIALIZABLE");
            } else {
                throw new IllegalArgumentException("ORMLite does not know how to store field class " + clazz.getName() + " for field " + this);
            }
        }
        ...
        if (fieldConfig2.isId()) {
            ...
            this.isId = true;
            this.isGeneratedId = true;
            String seqName = fieldConfig2.getGeneratedIdSequence();
    ...
    public void configDaoInformation(ConnectionSource connectionSource2, Class<?> parentClass) throws SQLException {
        MappedQueryForId<Object, Object> mappedQueryForId2;
        ...
        if (this.fieldConfig.isForeignAutoRefresh() || foreignColumnName != null) {
            ...
            if (tableConfig == null) {
                ...
                foreignDao2 = (BaseDaoImpl) DaoManager.createDao(connectionSource2, tableConfig);
                foreignTableInfo2 = foreignDao2.getTableInfo();
            }
            if (foreignColumnName == null) {
            ...
            foreignFieldType2 = findForeignFieldType(collectionClazz, parentClass, foundDao);
            foreignIdField2 = null;
            foreignTableInfo2 = null;
            mappedQueryForId2 = null;
        } else {
    ...
    public <FV> FV extractRawJavaFieldValue(Object object) throws SQLException {
        ...
        if (this.fieldGetMethod == null) {
            try {
                val = (FV) this.field.get(object);
            } catch (Exception e) {
                throw SqlExceptionUtil.create("Could not get field value for " + this, e);
            }
        } else {
            try {
                val = (FV) this.fieldGetMethod.invoke(object, new Object[0]);
            } catch (Exception e2) {
    ...
    public static FieldType createFieldType(ConnectionSource connectionSource2, String tableName2, Field field2, Class<?> parentClass) throws SQLException {
        ...
        return new FieldType(connectionSource2, tableName2, field2, fieldConfig2, parentClass);
    }
    ...
    public boolean equals(Object arg) {
        ...
        return this.field.equals(((FieldType) arg).field);
    }
    ...
    private FieldType findForeignFieldType(Class<?> clazz, Class<?> foreignClass, BaseDaoImpl<?, ?> foreignDao2) throws SQLException {

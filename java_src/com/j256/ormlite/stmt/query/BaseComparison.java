...
public abstract class BaseComparison implements Comparison {
    ...
    protected BaseComparison(String columnName2, FieldType fieldType2, Object value2, boolean isComparison) throws SQLException {
    ...
    public void appendArgOrValue(DatabaseType databaseType, FieldType fieldType2, StringBuilder sb, List<ArgumentHolder> argList, Object argOrValue) throws SQLException {

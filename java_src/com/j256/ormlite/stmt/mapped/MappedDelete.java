...
public class MappedDelete<T, ID> extends BaseMappedStatement<T, ID> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r12v0, resolved type: com.j256.ormlite.dao.ObjectCache */
    ...
    public int delete(DatabaseConnection databaseConnection, T data, ObjectCache objectCache) throws SQLException {
        try {
            ...
            throw SqlExceptionUtil.create("Unable to run delete stmt on object " + ((Object) data) + ": " + this.statement, e);
        }
    }

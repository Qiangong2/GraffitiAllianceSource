...
public class DatabaseTableConfig<T> {
    ...
    public static <T> Constructor<T> findNoArgConstructor(Class<T> dataClass2) {
        try {
            for (Constructor constructor2 : dataClass2.getDeclaredConstructors()) {
                Constructor<T> con = (Constructor<T>) constructor2;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r8v0, resolved type: java.util.ArrayList */
    /* JADX WARN: Multi-variable type inference failed */

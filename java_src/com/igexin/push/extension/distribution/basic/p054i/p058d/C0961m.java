...
/* renamed from: com.igexin.push.extension.distribution.basic.i.d.m */
public final class C0961m extends AbstractC0958j {
    public C0961m(String str, String str2) {
        super(str, str2);
    }
    ...
    public boolean mo5558a(C0813i iVar, C0813i iVar2) {
        return iVar2.mo5365e(this.f2493a) && iVar2.mo5362d(this.f2493a).toLowerCase().contains(this.f2494b);
    }

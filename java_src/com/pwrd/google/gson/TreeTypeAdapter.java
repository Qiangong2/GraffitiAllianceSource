...
import com.pwrd.google.gson.internal.C$Gson$Preconditions;
...
final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    /* synthetic */ TreeTypeAdapter(JsonSerializer jsonSerializer, JsonDeserializer jsonDeserializer, Gson gson2, TypeToken typeToken2, TypeAdapterFactory typeAdapterFactory, TreeTypeAdapter treeTypeAdapter) {
    ...
    public static TypeAdapterFactory newFactoryWithMatchRawType(TypeToken<?> exactType, Object typeAdapter) {
        return new SingleTypeFactory(typeAdapter, exactType, exactType.getType() == exactType.getRawType(), null, null);
    }
    ...
    private static class SingleTypeFactory implements TypeAdapterFactory {
        ...
        /* synthetic */ SingleTypeFactory(Object obj, TypeToken typeToken, boolean z, Class cls, SingleTypeFactory singleTypeFactory) {

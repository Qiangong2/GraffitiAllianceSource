...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new Comparator<Comparable>() {
        /* class com.pwrd.google.gson.internal.LinkedHashTreeMap.C12561 */
    ...
    public Node<K, V> find(K key, boolean create) {
        ...
        if (nearest != null) {
            ...
            throw new ClassCastException(String.valueOf(key.getClass().getName()) + " is not Comparable");
        }
        int i = this.size;
        this.size = i + 1;
        if (i > this.threshold) {
    ...
    private void rotateLeft(Node<K, V> root) {
        ...
        root.height = Math.max(i, i2) + 1;
        int i4 = root.height;
        if (pivotRight != null) {
            i3 = pivotRight.height;
        }
        pivot.height = Math.max(i4, i3) + 1;
    }
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(java.lang.Object r5) {
            ...
            L_0x002b:
                ...
                goto L_0x001c
            */
            throw new UnsupportedOperationException("Method not decompiled: com.pwrd.google.gson.internal.LinkedHashTreeMap.Node.equals(java.lang.Object):boolean");
        }
        ...
        public String toString() {
            return ((Object) this.key) + SimpleComparison.EQUAL_TO_OPERATION + ((Object) this.value);
        }
    ...
    private abstract class LinkedTreeMapIterator<T> implements Iterator<T> {
        ...
        /* synthetic */ LinkedTreeMapIterator(LinkedHashTreeMap linkedHashTreeMap, LinkedTreeMapIterator linkedTreeMapIterator) {
            this();
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new LinkedHashTreeMap<K, V>.LinkedTreeMapIterator(LinkedHashTreeMap.this) {
                /* class com.pwrd.google.gson.internal.LinkedHashTreeMap.EntrySet.C12571 */
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedHashTreeMap<K, V>.LinkedTreeMapIterator(LinkedHashTreeMap.this) {
                /* class com.pwrd.google.gson.internal.LinkedHashTreeMap.KeySet.C12581 */

...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new Comparator<Comparable>() {
        /* class com.pwrd.google.gson.internal.LinkedTreeMap.C12591 */
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(java.lang.Object r5) {
            ...
            L_0x002b:
                ...
                goto L_0x001c
            */
            throw new UnsupportedOperationException("Method not decompiled: com.pwrd.google.gson.internal.LinkedTreeMap.Node.equals(java.lang.Object):boolean");
        }
    ...
    private abstract class LinkedTreeMapIterator<T> implements Iterator<T> {
        ...
        /* synthetic */ LinkedTreeMapIterator(LinkedTreeMap linkedTreeMap, LinkedTreeMapIterator linkedTreeMapIterator) {
            this();
        }
    ...
    public class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new LinkedTreeMap<K, V>.LinkedTreeMapIterator(LinkedTreeMap.this) {
                /* class com.pwrd.google.gson.internal.LinkedTreeMap.EntrySet.C12601 */
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedTreeMap<K, V>.LinkedTreeMapIterator(LinkedTreeMap.this) {
                /* class com.pwrd.google.gson.internal.LinkedTreeMap.KeySet.C12611 */

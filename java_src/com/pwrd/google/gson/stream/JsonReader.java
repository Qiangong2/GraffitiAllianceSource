package com.pwrd.google.gson.stream;

import android.support.p007v4.view.MotionEventCompat;
import com.pwrd.google.gson.internal.JsonReaderInternalAccess;
...
public class JsonReader implements Closeable {
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
            /* class com.pwrd.google.gson.stream.JsonReader.C13061 */

            @Override // com.pwrd.google.gson.internal.JsonReaderInternalAccess
    ...
    private int peekNumber() throws IOException {
        ...
        while (true) {
            ...
            switch (c) {
                ...
                case 'E':
                case ResponseCode.PUSH_OPEN_FAIL_CODE /*{ENCODED_INT: 101}*/:
                    if (last == 2 || last == 4) {
                        last = 5;
                        break;
                    } else {
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        this.pos = 0;
        do {
            int total = this.f3113in.read(buffer2, this.limit, buffer2.length - this.limit);
            if (total == -1) {
                return false;
            }
            this.limit += total;
    ...
    private IOException syntaxError(String message) throws IOException {
        throw new MalformedJsonException(String.valueOf(message) + " at line " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
    }

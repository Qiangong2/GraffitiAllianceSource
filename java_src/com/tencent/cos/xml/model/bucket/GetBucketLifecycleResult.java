...
public final class GetBucketLifecycleResult extends CosXmlResult {
    ...
    public void parseResponseBody(HttpResponse response) throws CosXmlServiceException, CosXmlClientException {
        ...
        try {
            XmlParser.parseLifecycleConfiguration(response.byteStream(), this.lifecycleConfiguration);
    ...
    public String printResult() {
        return this.lifecycleConfiguration != null ? this.lifecycleConfiguration.toString() : super.printResult();
    }
}

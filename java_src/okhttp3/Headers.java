...
public final class Headers {
    ...
    public String toString() {
        ...
        int size = size();
        for (int i = 0; i < size; i++) {
            result.append(name(i)).append(": ").append(value(i)).append(IOUtils.LINE_SEPARATOR_UNIX);
        }
    ...
    /* renamed from: of */
    public static Headers m8172of(String... namesAndValues2) {
    ...
    /* renamed from: of */
    public static Headers m8171of(Map<String, String> headers) {
        if (headers == null) {

...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private Request followUpRequest(Response userResponse) throws IOException {
        ...
        switch (responseCode) {
            ...
            case GCloudVoiceErrno.GCLOUD_VOICE_TVE_INIT:
                break;
            case 307:
            case 308:
            ...
            case GCloudVoiceErrno.GCLOUD_VOICE_CDNV_NULL:
            ...
            case GCloudVoiceErrno.GCLOUD_VOICE_CDNV_URL:
        ...
        if (HttpMethod.permitsRequestBody(method)) {
            ...
            if (!maintainBody) {
                ...
                requestBuilder.removeHeader(HttpConstants.Header.CONTENT_TYPE);
            }
        }
        if (!sameConnection(userResponse, url)) {
            requestBuilder.removeHeader(HttpConstants.Header.AUTHORIZATION);
        }

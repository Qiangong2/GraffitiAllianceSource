...
import okhttp3.internal.p109io.FileSystem;
...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* class okhttp3.internal.cache.DiskLruCache.RunnableC21241 */
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
            /* class okhttp3.internal.cache.DiskLruCache.C21252 */
            static final /* synthetic */ boolean $assertionsDisabled = (!DiskLruCache.class.desiredAssertionStatus());
    ...
    public synchronized Editor edit(String key, long expectedSequenceNumber) throws IOException {
        ...
        synchronized (this) {
            ...
            validateKey(key);
            Entry entry = this.lruEntries.get(key);
            if ((expectedSequenceNumber == -1 || (entry != null && entry.sequenceNumber == expectedSequenceNumber)) && (entry == null || entry.currentEditor == null)) {
    ...
    public synchronized boolean remove(String key) throws IOException {
        ...
        synchronized (this) {
            ...
            validateKey(key);
            Entry entry = this.lruEntries.get(key);
            if (entry != null && (removed = removeEntry(entry)) && this.size <= this.maxSize) {
    ...
    public synchronized Iterator<Snapshot> snapshots() throws IOException {
        ...
        return new Iterator<Snapshot>() {
            /* class okhttp3.internal.cache.DiskLruCache.C21263 */
                ...
                if (this.done) {
                    ...
                    try {
                        blackhole = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
                            /* class okhttp3.internal.cache.DiskLruCache.Editor.C21271 */

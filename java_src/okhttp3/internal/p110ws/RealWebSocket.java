package okhttp3.internal.p110ws;
...
import okhttp3.internal.p110ws.WebSocketReader;
...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener listener2, Random random2) {
        ...
        this.key = ByteString.m8174of(nonce).base64();
        this.writerRunnable = new Runnable() {
            /* class okhttp3.internal.p110ws.RealWebSocket.RunnableC21441 */
    ...
    public void connect(OkHttpClient client) {
        ...
        final Request request = this.originalRequest.newBuilder().header("Upgrade", "websocket").header(HttpConstants.Header.CONNECTION, "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
        this.call = Internal.instance.newWebSocketCall(client2, request);
        this.call.enqueue(new Callback() {
            /* class okhttp3.internal.p110ws.RealWebSocket.C21452 */
    ...
    public void checkResponse(Response response) throws ProtocolException {
        ...
        String headerConnection = response.header(HttpConstants.Header.CONNECTION);
    ...
    @Override // okhttp3.internal.p110ws.WebSocketReader.FrameCallback
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0075, code lost:
        if ((r4 instanceof okhttp3.internal.p110ws.RealWebSocket.Message) == false) goto L_0x00ad;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0077, code lost:
        r3 = ((okhttp3.internal.p110ws.RealWebSocket.Message) r4).data;
        r8 = okio.Okio.buffer(r10.newMessageSink(((okhttp3.internal.p110ws.RealWebSocket.Message) r4).formatOpcode, (long) r3.size()));
        r8.write(r3);
        r8.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x00af, code lost:
        if ((r4 instanceof okhttp3.internal.p110ws.RealWebSocket.Close) == false) goto L_0x00c8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x00b1, code lost:
        r0 = (okhttp3.internal.p110ws.RealWebSocket.Close) r4;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p110ws.RealWebSocket.writeOneFrame():boolean");
    }

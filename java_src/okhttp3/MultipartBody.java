...
public final class MultipartBody extends RequestBody {
    ...
    public static final class Part {
        ...
        public static Part create(@Nullable Headers headers2, RequestBody body2) {
            ...
            } else if (headers2 != null && headers2.get(HttpConstants.Header.CONTENT_TYPE) != null) {
                throw new IllegalArgumentException("Unexpected header: Content-Type");
            } else if (headers2 == null || headers2.get(HttpConstants.Header.CONTENT_LENGTH) == null) {
        ...
        public static Part createFormData(String name, @Nullable String filename, RequestBody body2) {
            ...
            return create(Headers.m8172of(COSRequestHeaderKey.CONTENT_DISPOSITION, disposition.toString()), body2);
        }

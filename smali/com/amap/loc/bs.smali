...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/amap/loc/bs;->b:Ljava/lang/String;

    iput-object v1, p0, Lcom/amap/loc/bs;->c:Landroid/content/Context;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/amap/loc/bs;->d:Z

    iput-object v1, p0, Lcom/amap/loc/bs;->e:Lcom/amap/loc/g;

    iput-object v1, p0, Lcom/amap/loc/bs;->f:Landroid/content/ServiceConnection;

    iput-object v1, p0, Lcom/amap/loc/bs;->g:Landroid/content/ServiceConnection;

    iput-object v1, p0, Lcom/amap/loc/bs;->h:Landroid/content/ServiceConnection;

    new-instance v0, Landroid/content/Intent;

    invoke-direct {v0}, Landroid/content/Intent;-><init>()V

    iput-object v0, p0, Lcom/amap/loc/bs;->i:Landroid/content/Intent;

    const-string v0, "com.autonavi.minimap"

    iput-object v0, p0, Lcom/amap/loc/bs;->j:Ljava/lang/String;

    const-string v0, "com.amap.api.service.AMapService"

    iput-object v0, p0, Lcom/amap/loc/bs;->k:Ljava/lang/String;

    const-string v0, "com.autonavi.minimap.LBSConnectionService"

    iput-object v0, p0, Lcom/amap/loc/bs;->l:Ljava/lang/String;

    iput-boolean v2, p0, Lcom/amap/loc/bs;->m:Z

    iput-boolean v2, p0, Lcom/amap/loc/bs;->n:Z

    iput-boolean v2, p0, Lcom/amap/loc/bs;->o:Z

    iput-object v1, p0, Lcom/amap/loc/bs;->a:Lcom/amap/loc/bs$a;
    ...
    invoke-static {v0, v1}, Lcom/amap/loc/bz;->a([BLjava/lang/String;)[B
...
.method private a(Landroid/os/Bundle;)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    invoke-static {v0, v2}, Lcom/amap/loc/bz;->b([BLjava/lang/String;)[B
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2}, Lcom/amap/loc/m;->b(Ljava/lang/String;)[B

    move-result-object v2

    :try_start_1
    invoke-static {v0, v2}, Lcom/amap/loc/bz;->a([B[B)[B
    ...
    iget-object v2, p0, Lcom/amap/loc/bs;->p:Ljava/lang/String;
    ...
    :cond_2
    iget-object v2, p0, Lcom/amap/loc/bs;->q:Ljava/lang/String;
    ...
    :cond_3
    iget-object v2, p0, Lcom/amap/loc/bs;->r:Ljava/lang/String;
    ...
    :cond_4
    iget-object v2, p0, Lcom/amap/loc/bs;->s:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/amap/loc/bs;->c:Landroid/content/Context;
    ...
    const-class v2, Lcom/amap/loc/bs;
...
.method public a(Lcom/amap/loc/bs$a;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/amap/loc/bs;->g:Landroid/content/ServiceConnection;

    if-nez v0, :cond_1

    new-instance v0, Lcom/amap/loc/bs$2;

    invoke-direct {v0, p0}, Lcom/amap/loc/bs$2;-><init>(Lcom/amap/loc/bs;)V

    iput-object v0, p0, Lcom/amap/loc/bs;->g:Landroid/content/ServiceConnection;

    :cond_1
    iget-object v0, p0, Lcom/amap/loc/bs;->h:Landroid/content/ServiceConnection;

    if-nez v0, :cond_2

    new-instance v0, Lcom/amap/loc/bs$3;

    invoke-direct {v0, p0}, Lcom/amap/loc/bs$3;-><init>(Lcom/amap/loc/bs;)V
...
.method b()Z
    ...
    invoke-static {v0}, Lcom/amap/loc/ck;->b(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/amap/loc/bs;->i:Landroid/content/Intent;
    ...
    invoke-static {v0}, Lcom/amap/loc/ck;->c(Landroid/content/Context;)Z
...
.method public d()V
    ...
    check-cast v0, Lcom/amap/loc/cl;
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {v0}, Lcom/amap/loc/cl;->a()Z
    ...
    invoke-virtual {v0}, Lcom/amap/loc/cl;->b()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0}, Lcom/amap/loc/cl;->c()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/amap/loc/cl;->e()Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v0}, Lcom/amap/loc/cl;->d()Ljava/util/List;
    ...
    :cond_5
    invoke-virtual {v0}, Lcom/amap/loc/cl;->f()Z

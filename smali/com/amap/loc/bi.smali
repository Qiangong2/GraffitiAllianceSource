...
.method constructor <init>(IILjava/net/Proxy;ZLcom/amap/loc/bf$a;)V
    ...
    iput-object v0, p0, Lcom/amap/loc/bi;->e:Ljavax/net/ssl/SSLContext;
    :try_end_0
...
.method private a(Ljava/net/HttpURLConnection;)Lcom/amap/loc/bl;
    ...
    :goto_0
    new-instance v2, Lcom/amap/loc/h;
    ...
    iget-object v3, p0, Lcom/amap/loc/bi;->j:Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, Lcom/amap/loc/h;-><init>(Ljava/lang/String;)V
    ...
    :cond_7
    sget-object v0, Lcom/amap/loc/bi;->a:Lcom/amap/loc/bj;

    if-eqz v0, :cond_8

    sget-object v0, Lcom/amap/loc/bi;->a:Lcom/amap/loc/bj;

    invoke-interface {v0}, Lcom/amap/loc/bj;->a()V

    :cond_8
    new-instance v0, Lcom/amap/loc/bl;

    invoke-direct {v0}, Lcom/amap/loc/bl;-><init>()V

    invoke-virtual {v4}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object v6

    iput-object v6, v0, Lcom/amap/loc/bl;->a:[B

    iput-object v5, v0, Lcom/amap/loc/bl;->b:Ljava/util/Map;

    iget-object v5, p0, Lcom/amap/loc/bi;->j:Ljava/lang/String;

    iput-object v5, v0, Lcom/amap/loc/bl;->c:Ljava/lang/String;
    :try_end_b
    ...
    invoke-static {v4, v5, v6}, Lcom/amap/loc/t;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method a(Ljava/lang/String;Ljava/util/Map;[B)Lcom/amap/loc/bl;
    ...
    invoke-direct {p0, v0}, Lcom/amap/loc/bi;->a(Ljava/net/HttpURLConnection;)Lcom/amap/loc/bl;
    :try_end_0
    ...
    .catch Lcom/amap/loc/h; {:try_start_0 .. :try_end_0} :catch_7
...
.method a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    iget-object v2, p0, Lcom/amap/loc/bi;->k:Lcom/amap/loc/bf$a;

    if-eqz v2, :cond_0

    iget-object v0, p0, Lcom/amap/loc/bi;->k:Lcom/amap/loc/bf$a;

    iget-object v2, p0, Lcom/amap/loc/bi;->f:Ljava/net/Proxy;

    invoke-interface {v0, v2, v1}, Lcom/amap/loc/bf$a;->a(Ljava/net/Proxy;Ljava/net/URL;)Ljava/net/URLConnection;
    ...
    iget-object v0, p0, Lcom/amap/loc/bi;->f:Ljava/net/Proxy;
    ...
    :cond_1
    :goto_0
    iget-boolean v1, p0, Lcom/amap/loc/bi;->d:Z
    ...
    iget-object v2, p0, Lcom/amap/loc/bi;->e:Ljavax/net/ssl/SSLContext;
    ...
    iget-object v2, p0, Lcom/amap/loc/bi;->l:Ljavax/net/ssl/HostnameVerifier;
    ...
    :cond_2
    invoke-direct {p0, p2, v0}, Lcom/amap/loc/bi;->a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
...
.method a(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lcom/amap/loc/bh$a;)V
    ...
    invoke-virtual {p0, v2, p2, v4}, Lcom/amap/loc/bi;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    :try_end_2
    ...
    iget-wide v6, p0, Lcom/amap/loc/bi;->i:J
    ...
    invoke-direct {v0, v3}, Lcom/amap/loc/h;-><init>(Ljava/lang/String;)V

    invoke-interface {p4, v0}, Lcom/amap/loc/bh$a;->a(Ljava/lang/Throwable;)V
    ...
    iget-boolean v3, p0, Lcom/amap/loc/bi;->g:Z
    ...
    iget-wide v4, p0, Lcom/amap/loc/bi;->h:J
    ...
    iget-wide v6, p0, Lcom/amap/loc/bi;->h:J
    ...
    invoke-interface {p4, v0, v4, v5}, Lcom/amap/loc/bh$a;->a([BJ)V
    ...
    iput-wide v4, p0, Lcom/amap/loc/bi;->i:J
    :try_end_4
    ...
    invoke-interface {p4, v4, v6, v7}, Lcom/amap/loc/bh$a;->a([BJ)V
    :try_end_8
    ...
    :cond_c
    :try_start_b
    iget-boolean v0, p0, Lcom/amap/loc/bi;->g:Z

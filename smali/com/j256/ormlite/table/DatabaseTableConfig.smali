...
.method private static extractFieldTypes(Lcom/j256/ormlite/support/ConnectionSource;Ljava/lang/Class;Ljava/lang/String;)[Lcom/j256/ormlite/field/FieldType;
    ...
    .line 206
    .local v3, "fieldTypes":Ljava/util/List;, "Ljava/util/List<Lcom/j256/ormlite/field/FieldType;>;"
    move-object v0, p1

    .local v0, "classWalk":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    :goto_0
    if-nez v0, :cond_0
    ...
    const-string v6, "No fields have a "
    ...
    invoke-static {p0, p2, v1, p1}, Lcom/j256/ormlite/field/FieldType;->createFieldType(Lcom/j256/ormlite/support/ConnectionSource;Ljava/lang/String;Ljava/lang/reflect/Field;Ljava/lang/Class;)Lcom/j256/ormlite/field/FieldType;
    ...
    check-cast v4, [Lcom/j256/ormlite/field/FieldType;
...
.method public static findNoArgConstructor(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    const-string v6, "Can\'t find a no-arg constructor for "
    ...
    const-string v6, "Can\'t lookup declared constructors for "
    ...
    .restart local v2    # "consts":[Ljava/lang/reflect/Constructor;
    :cond_0
    ...
    const-string v6, "Could not open access to constructor for "
    ...
    .line 199
    const-string v6, ".  Missing static on inner class?"

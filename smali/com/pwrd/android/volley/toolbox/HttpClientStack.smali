.class public Lcom/pwrd/android/volley/toolbox/HttpClientStack;
...
.method public constructor <init>(Lorg/apache/http/client/HttpClient;)V
    ...
    .line 52
    iput-object p1, p0, Lcom/pwrd/android/volley/toolbox/HttpClientStack;->mClient:Lorg/apache/http/client/HttpClient;
...
.method static createHttpRequest(Lcom/pwrd/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 92
    .local p0, "request":Lcom/pwrd/android/volley/Request;, "Lcom/pwrd/android/volley/Request<*>;"
    .local p1, "additionalHeaders":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    invoke-virtual {p0}, Lcom/pwrd/android/volley/Request;->getMethod()I
    ...
    .line 97
    :pswitch_0
    invoke-virtual {p0}, Lcom/pwrd/android/volley/Request;->getPostBody()[B
    ...
    invoke-virtual {p0}, Lcom/pwrd/android/volley/Request;->getPostBodyContentType()Ljava/lang/String;
    ...
    .line 116
    invoke-static {v2, p0}, Lcom/pwrd/android/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/pwrd/android/volley/Request;)V
    ...
    .line 122
    invoke-static {v3, p0}, Lcom/pwrd/android/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/pwrd/android/volley/Request;)V
...
.method private static setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/pwrd/android/volley/Request;)V
    .locals 2
...
.method public performRequest(Lcom/pwrd/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    ...
    invoke-static {p1, p2}, Lcom/pwrd/android/volley/toolbox/HttpClientStack;->createHttpRequest(Lcom/pwrd/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;

    move-result-object v1

    .line 74
    .local v1, "httpRequest":Lorg/apache/http/client/methods/HttpUriRequest;
    invoke-static {v1, p2}, Lcom/pwrd/android/volley/toolbox/HttpClientStack;->addHeaders(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 75
    invoke-virtual {p1}, Lcom/pwrd/android/volley/Request;->getHeaders()Ljava/util/Map;

    move-result-object v3

    invoke-static {v1, v3}, Lcom/pwrd/android/volley/toolbox/HttpClientStack;->addHeaders(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 76
    invoke-virtual {p0, v1}, Lcom/pwrd/android/volley/toolbox/HttpClientStack;->onPrepareRequest(Lorg/apache/http/client/methods/HttpUriRequest;)V
    ...
    .line 83
    iget-object v3, p0, Lcom/pwrd/android/volley/toolbox/HttpClientStack;->mClient:Lorg/apache/http/client/HttpClient;
